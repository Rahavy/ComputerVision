...
for i in range(1,16):
    print("Oring img: " + str(i))
    path = 'C:/Users/joshu/OneDrive/Documents/GitHub/ComputerVision/Orings/Oring' + str(i) + '.jpg'
...
#erosion
    ...
    for x in range(1, dilated.shape[0]-1):#also goes to img
        for y in range(1, dilated.shape[1]-1):
            neighbourhood = dilated[x-1:x+2, y-1:y+2]#also looks at the area around the pixel
